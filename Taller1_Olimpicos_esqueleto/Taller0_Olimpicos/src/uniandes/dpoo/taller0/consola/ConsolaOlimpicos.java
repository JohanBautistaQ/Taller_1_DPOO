...
public class ConsolaOlimpicos
{
	...
	public void ejecutarBuscarPais() {
		System.out.println("\n" + "Pais al que representa un atleta" + "\n");
		String nombre = input("Ingrese el atleta de su interés");
		String strCountry = calculadora.paisPorAtletas(nombre);
		if (strCountry == null) {
			System.out.println("No se encuentro el atleta indicado");
		}
		else {
			System.out.println("El pais al que representa " + nombre + " es " + strCountry);	
